...
namespace imgui_addons
{
    ...
    bool ImGuiFileBrowser::showFileDialog(const std::string& label, const DialogMode mode, const ImVec2& sz_xy, bool* isOpen, const std::string& valid_types)
    {
        this->isOpen = isOpen;
        dialog_mode = mode;
    ...
    bool ImGuiFileBrowser::renderNavAndSearchBarRegion()
    {
        ...
        ImGui::BeginChild("##NavigationWindow", nw_size, true); //,ImGuiChildFlags_AlwaysAutoResize | ImGuiWindowFlags_NoScrollbar);
